...
echo ""
echo "Installed. Next:"
echo "  1. The zwisp window opens on Setup — grant the permissions from there."
echo "  2. Click the 🎙️ menu-bar icon → 'Launch at Login' to start on every boot."
echo "  3. Teach it names it mishears: menu-bar icon → Add Dictionary Word…"
